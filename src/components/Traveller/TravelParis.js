...
export default () => {
    ...
    useEffect(() => {
        ...
        setCidadeVolta("PARIS")
        setTempoViagem("14h20m")
    }, []);
    ...
    const selecionarViagem = () =>{
        if(userSection == ""){
            ...
            precoviagem: `${(56 * qtdQuarto) + (1030 * qtdAdulto)}`,
    ...
    return(
        <div>
            <div className = "pesquisaviagem">
                <div className="busca">
                    <label>DESTINO </label>
                    <input type="text" placeholder="🔍 PARIS" className="cidade--busca" />
                </div>
            ...
            <div className="seleciona--viagem--ida">
                ...
                <div className="dataCNF--ida">
                    ...
                    <label className="hora--travel">09:35</label>
                </div>                
                ...
                <div className="dataSDU--ida">
                    <label>SDU</label>
                    <label className="city--name">PARIS</label>
                    <label className="hora--travel">23:55</label>
                </div>
            ...
            <div className="seleciona--viagem--ida--indireto">
                ...
                <div className="dataCNF--ida">
                    <label>CNF</label>
                    <label className="city--name">BELO HORIZONTE</label>
                    <label className="hora--travel">15:00</label>
                </div>                
                <div className="direto--nome">
                ...
                <div className="dataSDU--ida">
                    <label>SDU</label>
                    <label className="city--name">PARIS</label>
                    <label className="hora--travel">06:30</label>
                </div>
                <div className="tempo--calculo">
                    <label>15h30m</label>
                </div>
            ...
            <div className="paymentarea">
                <div className="head">
                    ...
                    <label className="preco--adulto--reais">R$1030</label>
                </div>
                <div className="price--single">
                    <label className="qtd--adulto">{qtdAdulto} ADULTO{qtdAdulto > 1 ? "S" : ""}</label>
                    <label className="valor--adulto">R${1030 * qtdAdulto}</label>
                </div>
                <div className="taxas">
                ...
                <div className="preco--final">
                    ...
                    <label className="preco--final--valor">R${(56 * qtdQuarto) + (1030 * qtdAdulto)}</label>
