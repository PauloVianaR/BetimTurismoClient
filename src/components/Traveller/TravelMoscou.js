...
export default () => {
    ...
    useEffect(() => {
        ...
        setCidadeVolta("MOSCOU")
        setTempoViagem("21h40m")
    }, []);
    ...
    const selecionarViagem = () =>{
        if(userSection == ""){
            ...
            precoviagem: `${(56 * qtdQuarto) + (1465 * qtdAdulto)}`,
    ...
    return(
        <div>
            <div className = "pesquisaviagem">
                <div className="busca">
                    <label>DESTINO </label>
                    <input type="text" placeholder="🔍 Moscou" className="cidade--busca" />
                </div>
            ...
            <div className="seleciona--viagem--ida">
                ...
                <div className="dataCNF--ida">
                    ...
                    <label className="hora--travel">13:50</label>
                </div>                
                ...
                <div className="dataSDU--ida">
                    <label>SDU</label>
                    <label className="city--name">MOSCOU</label>
                    <label className="hora--travel">11:30</label>
                </div>
            ...
            <div className="seleciona--viagem--ida--indireto">
                ...
                <div className="dataCNF--ida">
                    <label>CNF</label>
                    <label className="city--name">BELO HORIZONTE</label>
                    <label className="hora--travel">10:30</label>
                </div>                
                <div className="direto--nome">
                ...
                <div className="dataSDU--ida">
                    <label>SDU</label>
                    <label className="city--name">MOSCOU</label>
                    <label className="hora--travel">08:38</label>
                </div>
                <div className="tempo--calculo">
                    <label>22h08m</label>
                </div>
            ...
            <div className="paymentarea">
                <div className="head">
                    ...
                    <label className="preco--adulto--reais">R$1465</label>
                </div>
                <div className="price--single">
                    <label className="qtd--adulto">{qtdAdulto} ADULTO{qtdAdulto > 1 ? "S" : ""}</label>
                    <label className="valor--adulto">R${1465 * qtdAdulto}</label>
                </div>
                <div className="taxas">
                ...
                <div className="preco--final">
                    ...
                    <label className="preco--final--valor">R${(56 * qtdQuarto) + (1465 * qtdAdulto)}</label>
