...
export default () => {
    ...
    const selecionarViagem = () =>{
        if(userSection == ""){
            ...
            precoviagem: `${(56 * qtdQuarto) + (100 * qtdAdulto)}`,
    ...
    return(
        <div>
            <div className = "pesquisaviagem">
                <div className="busca">
                    <label>DESTINO </label>
                    <input type="text" placeholder="🔍 Rio de Janeiro" className="cidade--busca" />
                </div>
            ...
            <div className="seleciona--viagem--ida">
                ...
                <div className="dataCNF--ida">
                    ...
                    <label className="hora--travel">18:15</label>
                </div>                
                ...
                <div className="dataSDU--ida">
                    <label>SDU</label>
                    <label className="city--name">RIO DE JANEIRO</label>
                    <label className="hora--travel">19:20</label>
                </div>
            ...
            <div className="seleciona--viagem--ida--indireto">
                ...
                <div className="dataCNF--ida">
                    <label>CNF</label>
                    <label className="city--name">BELO HORIZONTE</label>
                    <label className="hora--travel">17:30</label>
                </div>                
                <div className="direto--nome">
                ...
                <div className="dataSDU--ida">
                    <label>SDU</label>
                    <label className="city--name">RIO DE JANEIRO</label>
                    <label className="hora--travel">20:10</label>
                </div>
                <div className="tempo--calculo">
                    <label>2h40m</label>
                </div>
            ...
            <div className="paymentarea">
                <div className="head">
                    ...
                    <label className="preco--adulto--reais">R$100</label>
                </div>
                <div className="price--single">
                    <label className="qtd--adulto">{qtdAdulto} ADULTO{qtdAdulto > 1 ? "S" : ""}</label>
                    <label className="valor--adulto">R${100 * qtdAdulto}</label>
                </div>
                <div className="taxas">
                ...
                <div className="preco--final">
                    ...
                    <label className="preco--final--valor">R${(56 * qtdQuarto) + (100 * qtdAdulto)}</label>
